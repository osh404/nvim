...
-- 2. 文件与编码
------------------------------------------------------------------------------
vim.opt.encoding = "UTF-8"     -- Vim 内部使用 UTF-8 编码
vim.opt.fileencoding = "utf-8" -- 文件默认保存编码为 UTF-8

------------------------------------------------------------------------------
-- 3. 光标与滚动
------------------------------------------------------------------------------
vim.opt.scrolloff = 8     -- 光标上下保留 8 行可见区域
vim.opt.sidescrolloff = 8 -- 光标左右滚动时保留 8 列可见区域
...
vim.wo.signcolumn = "yes"    -- 显示符号列（调试、LSP 必需），不要用 "no"
...
vim.bo.tabstop = 4
vim.opt.softtabstop = 4   -- 插入模式下 Tab 的软宽度
vim.opt.shiftround = true -- >> << 时对齐到 shiftwidth 的倍数
vim.opt.shiftwidth = 4    -- 自动缩进时每级缩进为 4 个空格
vim.bo.shiftwidth = 4
vim.opt.expandtab = true  -- 将 Tab 转为空格
vim.bo.expandtab = true
-- vim.opt.autoindent = true  -- 自动继承上一行缩进
-- vim.bo.autoindent = true
vim.opt.smartindent = true -- 根据语法自动缩进

---------------------------------------------------------------------------------
----- 7. 文件自动保存与读取
---------------------------------------------------------------------------------
vim.opt.autowrite = true -- 切换 buffer 时自动保存
vim.opt.autoread = true  -- 外部修改文件后自动重新加载
...
vim.opt.smartcase = true  -- 若有大写字母，则开启智能大小写搜索
...
vim.wo.wrap = true                  -- 自动折行(当一行文本的长度超过屏幕宽度时自动换行)
vim.opt.whichwrap = "b,s,<,>,[,],~" -- 允光标在行首尾时允许使用 <Left>/<Right> 跨行移动
---
---------------------------------------------------------------------------------
----- 12. 缓冲区与鼠标支持
---------------------------------------------------------------------------------
---vim.o.hidden = true -- 允许切换未经保存的 buffer
----- iTerm2上要打开(Preferences > Profiles > Your Profile > Terminal > Enable mouse reporting)
...
----- 定义空格和 Tab 的可见字符
vim.opt.wildmenu = true -- 命令行补全时显示菜单
---
---------------------------------------------------------------------------------
----- 16. 系统剪切板
---------------------------------------------------------------------------------
